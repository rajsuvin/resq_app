...
class Officersettingpage extends StatefulWidget {
  static const String path = "lib/src/pages/settings/settings1.dart";

  const Officersettingpage({super.key});

  @override
  _OfficersettingpageState createState() => _OfficersettingpageState();
}

class _OfficersettingpageState extends State<Officersettingpage> {
  late bool _dark;
